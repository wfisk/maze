...
var app = (function () {
    ...
    /* src/stores/layout.svelte generated by Svelte v3.6.11 */
    ...
    function createLayout() {
      ...
      subscribe,
    		...
    		setColumnCount: value => update( self => {
        self.columnCount = value;
        return self;
      }),

    		setRowCount: value => update( self => {
        self.rowCount = value;
        return self;
      }),

    		addSpace: value => update( self => {
        self.spaces.push( value );
        return self;
      }),

    		removeSpace: value => update( self => {
        ...
        return self;
    		...
    		setStart: value => update( self => {
        self.start = value;
        return self;
      }),

    		setEnd: value => update( self => {
        self.end = value;
        return self;
      }) 
    ...
    class Layout extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["layout"]);
    	}
    ...
    /* src/Maze.svelte generated by Svelte v3.6.11 */
    ...
    function create_each_block_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(line, file, 94, 5, 1810);
    			attr(text_1, "y", "-4");
    			attr(text_1, "class", "svelte-2flq1i");
    			add_location(text_1, file, 95, 5, 1839);
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(rect, file, 111, 4, 2255);
    		},
