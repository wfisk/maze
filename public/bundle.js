...
var app = (function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_store(mazeGrid, 'mazeGrid');
    	component_subscribe($$self, mazeGrid, $$value => { $mazeGrid = $$value; $$invalidate('$mazeGrid', $mazeGrid); });
